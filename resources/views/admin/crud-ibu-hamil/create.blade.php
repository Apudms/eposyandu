        ...
        <div class="row">
          <div class="col">
            <div class="card card-info">
              ...
              <form class="form-horizontal" action="/admin/ibu-hamil" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <input type="text" class="form-control" id="namaIbuHamil" name="namaIbuHamil" placeholder="Nama Bumil" required value="{{ old('namaIbuHamil') }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <input type="text" class="form-control" id="namaSuami" name="namaSuami" placeholder="Nama Suami" required value="{{ old('namaSuami') }}">
                    </div>
                  </div>
