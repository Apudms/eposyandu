        ...
        <div class="row">
          <div class="col">
            <div class="card card-info">
              ...
              <form class="form-horizontal" action="/admin/peserta-kb" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <input type="text" class="form-control" id="namaPeserta" name="namaPeserta" placeholder="Nama Peserta" required value="{{ old('namaPeserta') }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <input type="text" class="form-control" id="namaPasangan" name="namaPasangan" placeholder="Nama Pasangan" required value="{{ old('namaPasangan') }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                      <input type="date" class="form-control" id="tanggalDaftar" name="tanggalDaftar" placeholder="Tanggal Daftar" required value="{{ old('tanggalDaftar') }}">
                    </div>
                  </div>
