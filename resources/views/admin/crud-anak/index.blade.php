                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $a->imunisasi->jenisImun }}</td>
                      <td class="text-center">
                        <a href="/admin/anak/{{ $a->id }}" class="text-secondary"><i class="fas fa-eye"></i></a>
                        <a href="/admin/anak/{{ $a->id }}/edit" class="text-primary m-2"><i class="fas fa-edit"></i></a>
                        <form action="/admin/anak/{{ $a->id }}" method="post" class="d-inline">
                          @method('delete')
                          @csrf
